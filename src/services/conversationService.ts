...
import { DocumentResult, SectionResult, functions, getDocument, getSection, notifyHuman } from "./functions";
...
export async function processMessage(id: string) {
  ...
  // const contextContent= await getContext(conversation.clientId, input)
  // const messages: ChatCompletionMessageParam[]= getGPTMessages(conversation.messages as ChatCompletionUserOrSystem[], conversation.client.prompt, contextContent)
