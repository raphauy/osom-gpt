    ...
    <main className="flex flex-col items-center justify-between w-full pb-40">
      <div className="flex items-center justify-between w-full my-5">        
        ...
        <div className="flex items-center gap-2">
          <DeleteConversationDialog id={conversationId} description={`Seguro que desea eliminar la conversación de ${userEmail}?`} redirectUri={`/client/${slug}/simulator-streaming?r=${new Date().getMilliseconds()}`} />
        </div>
      </div>
